...
// Components
import { ErrorBoundary, ColumnNavigation, ColumnContent, ColumnInfo, Lesson7PersonComponents } from '../../components';
...
const Lesson7PersonPages: FC = () => {
    return (
        <S.Inner>
            ...
            <ColumnContent>
                <S.Title>Подробная информация о персонаже: </S.Title>
                <Lesson7PersonComponents />
            </ColumnContent>
            <ColumnInfo>

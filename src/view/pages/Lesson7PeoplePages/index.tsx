...
// Components
import { ErrorBoundary, ColumnNavigation, ColumnContent, ColumnInfo, Lesson7PeopleComponents } from '../../components';
...
const Lesson7PeoplePages: FC = () => {
    return (
        <S.Inner>
            ...
            <ColumnContent>
                <S.Title>Звездные войны:</S.Title>
                <Lesson7PeopleComponents/>
            </ColumnContent>
            <ColumnInfo>
